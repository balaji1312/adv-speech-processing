...
from transformers import AutoTokenizer, AutoModelForCTC, AutoProcessor
...
#This will be as per your folder structure.
import argparse
...
REF="_1h_withlm_ref.txt"  #Your choice of suffix
HYP="_1h_withlm_hyp.txt"  #Your choice of suffix
...
#"test_1h_withlm_ref.txt" and "test_1h_withlm_hyp.txt"
...
def map_to_result(batch):
    ...
    batch["pred_str"] = processor_with_lm.batch_decode(logits.numpy()).text[0]
...
model = AutoModelForCTC.from_pretrained(checkpoint_model)
processor = AutoProcessor.from_pretrained(checkpoint_model)
...
# decoder.save_to_dir(checkpoint_model)
...
print(checkpoint_model, dataset, args.lm)
