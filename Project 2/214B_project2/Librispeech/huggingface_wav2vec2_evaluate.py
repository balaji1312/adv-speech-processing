...
REF="_base_1h_ref.txt" #Your choice of suffix
HYP="_base_1h_hyp.txt" #Your choice of suffix
...
#"test_other_base_1h_ref.txt" and "test_other_base_1h_hyp.txt"
...
def map_to_result(batch):
    ...
    #print ("Prediction: ", batch["pred_str"])
