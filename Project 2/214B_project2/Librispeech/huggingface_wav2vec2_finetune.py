...
demo_finetuned_model = "large_5e5"
...
#UPDATE THE FOLLOWING CSV FILE NAMES AS PER YOUR EXPERIMENTS
...
libri_data = libri_data.map(prepare_dataset, remove_columns=libri_data.column_names["train"], num_proc=8)
